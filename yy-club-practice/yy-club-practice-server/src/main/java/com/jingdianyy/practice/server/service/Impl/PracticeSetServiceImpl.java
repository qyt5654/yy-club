...
import com.jingdianyy.practice.api.common.PageInfo;
import com.jingdianyy.practice.api.common.PageResult;
import com.jingdianyy.practice.api.enums.CompleteStatusEnum;
import com.jingdianyy.practice.api.enums.IsDeletedFlagEnum;
import com.jingdianyy.practice.api.enums.SubjectInfoTypeEnum;
...
import com.jingdianyy.practice.server.service.PracticeSetService;
...
public class PracticeSetServiceImpl implements PracticeSetService {
    ...
    public PracticeSetVO addPractice(PracticeSubjectDTO dto) {
        ...
        practiceSetPO.setIsDeleted(IsDeletedFlagEnum.UN_DELETE.getCode());
        ...
        practiceList.forEach(e -> {
            ...
            detailPO.setIsDeleted(IsDeletedFlagEnum.UN_DELETE.getCode());
