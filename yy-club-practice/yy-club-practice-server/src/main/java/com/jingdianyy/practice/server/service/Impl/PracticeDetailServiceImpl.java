package com.jingdianyy.practice.server.service.Impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.nacos.common.utils.CollectionUtils;
import com.jingdianyy.practice.api.enums.*;
import com.jingdianyy.practice.api.req.*;
import com.jingdianyy.practice.api.vo.*;
import com.jingdianyy.practice.server.dao.*;
import com.jingdianyy.practice.server.entity.dto.*;
import com.jingdianyy.practice.server.entity.po.*;
import com.jingdianyy.practice.server.rpc.UserRpc;
import com.jingdianyy.practice.server.service.PracticeDetailService;
import com.jingdianyy.practice.server.util.DateUtils;
import com.jingdianyy.practice.server.util.LoginUtil;
import com.jingdianyy.practice.server.dao.PracticeDao;
import com.jingdianyy.practice.server.dao.PracticeDetailDao;
import com.jingdianyy.practice.server.dao.PracticeSetDao;
import com.jingdianyy.practice.server.dao.PracticeSetDetailDao;
...
public class PracticeDetailServiceImpl implements PracticeDetailService {
    ...
    public Boolean submit(SubmitPracticeDetailReq req) {
        ...
        practicePO.setIsDeleted(IsDeletedFlagEnum.UN_DELETE.getCode());
        ...
        if (CollectionUtils.isNotEmpty(minusList)) {
            minusList.forEach(e -> {
                ...
                practiceDetailPO.setIsDeleted(IsDeletedFlagEnum.UN_DELETE.getCode());
